...
const AddUser = () => {
  ...
  // useEffect=(()=>{
  //   fetchdata=async ()=>{
  //     const response= await axios.get(`${ipadr}/get_managers_list`);
  //     let ManagerList= response.data && Array.isArray(response.data.get_managers_list)?
  //     response.data.get_managers_list:[];
  //   } 
  // },[]);
